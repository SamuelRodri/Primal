...
void APrimalCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &APrimalCharacter::Move);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &APrimalCharacter::Look);
...
void APrimalCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void APrimalCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void APrimalCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void APrimalCharacter::DoJumpEnd()
{
